...
- A `$prp-plan-review` report against an existing plan (a `reviews/*-review.md` path or pasted review findings) routes to `workflows/revise-from-review.md` and stops.
...
- `workflows/revise-from-review.md` — fold a `$prp-plan-review` report back into the plan
